...
function Header() {
  return (
    <div className="quad-section quad-section__navbar header-section header-section__primary header-section--shift header-section__navbar">
      <Link className="first-element align__left link-remove link-remove--white header-title__main-logo" to="/">Pro Hockey Tracker</Link>
