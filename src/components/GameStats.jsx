    ...
    <div>
      ...
      <div className="quint-section quint-section__side-margin list">
        <div className="second-element">
          ...
          <div className="padding-small">{liveData.boxscore.teams.home.teamStats.teamSkaterStats.faceOffWinPercentage}</div>
          <div className="padding-small">{liveData.boxscore.teams.home.teamStats.teamSkaterStats.powerPlayPercentage}</div>
        ...
        <div className="third-element">
          ...
          <div className="padding-small">FO%</div>
          <div className="padding-small">PP%</div>
          <div className="padding-small">PiM</div>
          <div className="padding-small">Take Aways</div>
          <div className="padding-small">Give Aways</div>
        </div>
        <div className="fourth-element">
          ...
          <div className="padding-small">{liveData.boxscore.teams.away.teamStats.teamSkaterStats.faceOffWinPercentage}</div>
          <div className="padding-small">{liveData.boxscore.teams.away.teamStats.teamSkaterStats.powerPlayPercentage}</div>
